...
On the first day, half of those 5 people(i.e., floor(5/2) == 2) like the advertisement and each shares it with 3 of their frinds. At the beginning of the second day, (floor(5/2) * 3 = 2 * 3 = 6) people receive the advertisement.
